...
const nav = [
  ...
  { href: "/programacion", label: "Programación semanal", icon: CalendarClock },
  { href: "/control-usuarios", label: "Control de usuarios", icon: ListChecks },
  { href: "/llamadas", label: "Llamadas 1:1", icon: PhoneCall },
  { href: "/graduacion-batallas", label: "Graduación de batallas", icon: Swords },
  { href: "/sugerencia-video", label: "Sugerencia de video", icon: Clapperboard },
  { href: "/batallas-oficiales", label: "Batallas oficiales", icon: Medal },
